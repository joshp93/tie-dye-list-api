package api.tiedyelist.converters;

import api.tiedyelist.exceptions.NotReadableException;
...
public class ObjectToUrlEncodedConverter implements HttpMessageConverter {
    ...
    @Override
    public Object read(Class aClass, HttpInputMessage httpInputMessage) throws HttpMessageNotReadableException {
        throw new HttpMessageNotReadableException("Can't read this you fool", new NotReadableException());
    }
    ...
    public void write(Object o, MediaType mediaType, HttpOutputMessage httpOutputMessage) throws HttpMessageNotWritableException {
        ...
        try {
            httpOutputMessage.getBody().write(body.getBytes(Encoding));
        } catch (IOException e) {
